...
; (function ($, win, doc, undefined) {
	...
	var menuArray = {"menu":[
		{ "name":"About CCK", "link":"/html/renewal/ENG-02-01.html", "dep2": [
		...
		{ "name":"Participation", "link":"/html/renewal/ENG-03-01.html", "dep2": [
			...
			{ "name":"Korea Donor Advised Fund", "link":"/html/renewal/ENG-03-09.html"},
			{ "name":"Corporate Giving", "link":"/html/renewal/ENG-03-10.html"},
			{ "name":"Annual Campaign with Hope", "link":"/html/renewal/ENG-03-11.html"}
		]},
		{ "name":"Support", "link":"/html/renewal/ENG-04-01.html", "dep2": [
			{ "name":"Support for Basic Needs", "link":"/html/renewal/ENG-04-01.html"},
			{ "name":"Support for Education", "link":"/html/renewal/ENG-04-02.html"},
			{ "name":"Improved Housing", "link":"/html/renewal/ENG-04-03.html"},
			{ "name":"Support for Healthcare", "link":"/html/renewal/ENG-04-04.html"},
			{ "name":"Support for Mental", "link":"/html/renewal/ENG-04-05.html"},
			{ "name":"Expanding Social Care", "link":"/html/renewal/ENG-04-06.html"},
			{ "name":"Advocacy for Community Participation", "link":"/html/renewal/ENG-04-07.html"},
            { "name":"Reducing Cultural Disparities", "link":"/html/renewal/ENG-04-08.html"}
		]},
		{ "name":"Philanthropy", "link":"/html/renewal/ENG-05-01.html", "dep2": [
			{ "name":"Philanthropy Education", "link":"/html/renewal/ENG-05-01.html"},
			{ "name":"Research on Philanthropy", "link":"/html/renewal/ENG-05-02.html"}
		]}		
	]};
	...
	$plugins.common = {
		...
		header: function (opt) {
            ...
            function gnbShow(t){
                ...
                $(t).closest('.nav-main-1').siblings('li').find('.nav-btn-2').data('selected',false);
				if (!$(t).data('selected')) {
			...
			if(Number(menucode[0]) > 0) {
                ...
                $li_1.eq(Number(menucode[0])).find('.nav-btn-2').addClass('selected');
